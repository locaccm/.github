...
## Composition de l'équipe
 ...
 - **Axel BOUTEILLER** => Scrum Master & développement du micro-service (https://github.com/locaccm/wealthManagement) & gestion de la base de données (https://github.com/locaccm/prisma)
